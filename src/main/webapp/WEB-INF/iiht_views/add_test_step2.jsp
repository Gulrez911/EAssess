		...
		<div class="wrapper">
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="column col-sm-10 col-xs-11" id="main">
					<!-- main contain -->
					<div class="rightside">
						<div class="rightdiv settest"
							style="width: 100%; padding-right: 15px; height: 550px;">


							<div class="teststeps">
								<div class="steps">
									<span>1</span> <label><img src="images/u1107.png">Set
										your test</label>
								</div>
								...
								<div class="steps active">
									<span>2</span> <label><img src="images/u1105.png">Add
										Questions</label>
								</div>
								<div class="steps line">
									<img src="images/u1102.png">
								...
								<div class="steps">
									<span>3</span> <label><img src="images/u1114.png">Add
										Candidates</label>
								</div>
								<div class="steps line">
									<img src="images/u1102.png">
								...
								<div class="steps">
									<span>4</span> <label><img src="images/u1106.png">Send
										Invitation</label>
								</div>
							</div>
							...
							<div class="addqueform">
									...
									<div class="quesectiondiv">
										<c:forEach items="${test.sectionDtos}" var="section">
											<div style="${section.style}">
												<h4 style="font-size: 14; font-weight: bold;"
													onclick="highlight('${section.sectionName}');return false">${section.sectionName}
													-</h4>
												<h4 id="no-${section.sectionName}"
													style="font-size: 14; font-weight: bold;">${section.noOfQuestions}
												</h4>
												<a
								...
								<div class="step2content">
									<b><h4 class="sectionlabel">Import Questions into
											Section</h4></b>
									...
									<div class="questiontable">
										<div class="questionheading">
											<div class="right" style="float: left; width: 30%;">
												...
												<div class="searchdata">
													...
													<form action="searchQs" method="get">
														<input type="text" placeholder="Search a Q"
															name="searchText" id="searchText" style="width: 170%">
											...
											<div class="queselected">
												...
												<input type="text" id="sectionTopic"
													placeholder="Enter Section Name" style="width: 13%;"
													value="${sectionDto.sectionName}" /> <a href="addteststep2"
													id="showAllQs" style="color: #492a26"> Show All Parent
													Categories |</a> <a href="javascript:showSelected();"
													id="showSelected" style="color: #228B22"> Show Selected
													|</a> <a href="removeAllQuestions" style="color: red">Clear
													All |</a> <a style="color: #020014;"
													href="javascript:saveSection();">Save Section</a> <input
													type="label" value="Percent of Qs to be asked -"
													style="border: none; font-size:" 8px" /> <input
													type="number" onKeyPress="return check(event,value)"
													onInput="checkLength()" id="txtF"
													placeholder="Enter percentage" style="width: 7%;"
													value="${sectionDto.percentQuestionsAsked}" />
											</div>
											<br>
										...
										<div class="questiontablelist"
											style="height: 500px; overflow-x: auto; padding-top: 0;">
											<table class="table">
												<thead>
													<tr>
												...
												<tbody>
													...
													<c:forEach items="${qs}" var="ques">
														<tr id="${ques.id}"
															...
															<td><input type="text"
																placeholder="Marks, if Correct" value="1  " disabled
																style="width: 100%;"></td>
									...
									<form>
										...
										<div class="formfield">
											...
											<div class="addanother">
												<a id="addanother" href="javascript:void(0);"><span>+</span>
													Add another option</a>
											</div>
										</div>
										<div class="formfield addimagevideo">
											<a class="addimage" href="#">Add image</a> <a
												class="addaudio" href="#">Add audio</a> <a class="addvideo"
												href="#">Add Video</a>
										</div>
										<label class="queimage"></label> <label class="queaudio"></label>
										<label class="quevideo"></label> <input type="file"
											name="addimage" id="addimage" style="display: none;">
										<input type="file" name="addaudio" id="addaudio"
						...
						<div class="nextbuttons">
							<a class="cancelbtn" href="testlist">Cancel</a> <a
								class="backbtn backstep1" href="gobackStep1Test">Back</a> <a
								class="nextbtn add_test_step3" href="addteststep3">Next</a>
						</div>
					...
					<script>
						function saveSection() {
							...
							if (name.trim().length == 0) {
								...
								window.location = 'saveSection?sectionTopic='
										+ name + '&percentage=' + txtFValue;
						...
						function addQ(qid, sectionName) {
							...
							var url = "addQuestionToSectionAjax?sectionName="
						...
						function highlight(sectionName) {
							window.location = "goToSection?sectionName="
									+ sectionName;
						}
						...
						$('#search')
								.on(
										...
										function() {
											...
											if (text.length != 0) {
												window.location = "searchQs?searchText="
														+ text;
											}
										});
